...
public interface IAiService
{
    ...
    Task<GeneratedQuestionDto?> GenerateQuestionAsync(string language, string topic, string difficulty, string? contentLanguage = null, CancellationToken cancellationToken = default);
}
